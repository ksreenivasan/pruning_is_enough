...
conf_file="configs/hypercube/resnet20/resnet20_quantized_iter_hc_target_sparsity_20_without_unflag.yml"
log_root="resnet20_sp13_"
log_end="_log"
subfolder_root="resnet20_sp13_results_trial_"
