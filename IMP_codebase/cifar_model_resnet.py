...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, ignore_name=None):
        ...
        self.prunable_layer_names = self.prunable_layer_names()
        if ignore_name is not None:
            self.prunable_layer_names -= set(ignore_name.split(','))
        print("Prunable Layers are: ", self.prunable_layer_names)
...
def resnet20(ignore_name):
    return ResNet(BasicBlock, [3, 3, 3], 10, ignore_name)
