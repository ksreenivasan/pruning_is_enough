...
class Conv4(nn.Module):
    def __init__(self, input_size, num_classes, args):
        ...
        self.conv1 = MaskConv(3, 64, kernel_size=(3, 3), stride=1, padding=1, bias=args.bias)
        self.conv2 = MaskConv(64, 64, kernel_size=(3, 3), stride=1, padding=1, bias=args.bias)
        self.conv3 = MaskConv(64, 128, kernel_size=(3, 3), stride=1, padding=1, bias=args.bias)
        self.conv4 = MaskConv(128, 128, kernel_size=(3, 3), stride=1, padding=1, bias=args.bias)
