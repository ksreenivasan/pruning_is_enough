...
python mnist_pruning_exps.py --algo hc_iter --lr 0.01 --optimizer adam --wd 0 --scores-init unif --epochs 100 --round naive --save-model # train & test for rounded version (iterative HC)
...
#python mnist_pruning_exps.py --algo hc --lr 0.01 --optimizer adam --wd 0 --scores-init unif --evaluate-only --epochs 50 --round prob --num-test 100  # only test
