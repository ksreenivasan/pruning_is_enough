...
def init_smart_ratio(parser_args):
    if parser_args.arch.lower() == 'resnet20':
        if parser_args.target_sparsity == 3.72:
            parser_args.init_sr = [41.43518518518518,  24.305555555555557, 21.875, 19.57465277777778, 17.36111111111111, 
            ...
            parser_args.init_sr = [34.49074074074074, 9.114583333333334, 8.203125, 7.335069444444445, 6.510416666666667, 
