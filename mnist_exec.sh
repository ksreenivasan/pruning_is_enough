...
#python mnist_hc.py --algo hc_iter --lr 0.01 --epochs 50 --optimizer adam --wd 0 --iter_period 1 --results-filename hc_iter_period_1_adam_lr_1e-2_50epoch.csv
python mnist_hc.py --algo hc_iter --lr 0.01 --epochs 50 --optimizer adam --wd 0 --iter_period 1 --evaluate-only
